...
export default function Card(props: Works) {
  ...
  return (
    ...
    >
      <div className='w-full min-h-32 md:min-h-44 max-h-44 border-b overflow-hidden border-gray/70'>
        <Image
          src={src}
          alt={`screenshot of ${name} project`}
          width={500}
          height={500}
          className='w-full  group-hover:scale-110  duration-200 object-cover ease-in-out'
          placeholder='blur'
          unoptimized
        />
      </div>
