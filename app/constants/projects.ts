...
export const projects: Works[] = [
  {
    id: 15,
    name: 'WordQuest',
    stack: ['vue3', 'tailwind', 'typescript'],
    github: 'https://github.com/efezinoidisi/word-quest',
    preview: 'https://word-quest-taupe.vercel.app/',
    src: images.wordQuest,
    brief: '',
  },
  {
    id: 1,
    ...
    brief:
      'A online furiture shop that offers a variety of different furnitures. This app mirrors the functionalities of an e-commerce application',
  },

  {
    ...
    src: images.movies,
    brief:
      'A movie web application that provides the latest information about movies, tv shows and celebrities.',
  },
  {
    id: 11,
    name: 'space tourism',
    ...
    src: images.space,
    brief: 'A frontend mentor challenge.',
  },
  {
    id: 0,
    name: 'my portfolio',
...
export const teamProjects: Works[] = [
  {
    id: 5,
    name: 'gourmetGo',
    stack: ['react', 'react-router', 'tailwindcss', 'leaflet'],
    github: 'https://github.com/chingu-voyages/v50-tier2-team-12/pull/63',
    preview: 'https://gourmet-go.netlify.app/',
    src: images.gourmetGo,
    brief:
      'This web application offers a diverse menu from different restaurants in different locations. It also simulates a restaurant ordering system.',
  },
  {
    id: 6,
    name: 'ProAlx',
...
export const landingPages: Works[] = [
  {
    ...
    brief: 'A landing page for a fictional real-estate company',
  },
];
...
const allProjects = [...projects, ...teamProjects, ...landingPages];
